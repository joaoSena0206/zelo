...
const routes: Routes = [
  ...
  {
    path: 'carteira-trabalhador',
    loadChildren: () => import('./trabalhador/Logado/carteira-trabalhador/carteira-trabalhador.module').then( m => m.CarteiraTrabalhadorPageModule)
  },
  {
